...
//*********on change ici 
        ...
        values.add(Integer.parseInt(actu.getnbrlikes()));
        values.add(Integer.parseInt(actu.getmoy()));
        values.add(Integer.parseInt(actu.getposts()));
        ...
        //******************************************ajouter de nouveau attribut a pie chart 
        List<String> aList = new ArrayList<>();
        aList.add("likes");
        aList.add("likes/post");
        aList.add("Nombre de posts");
        aList.add("Age moyen utilisateur");
        //aList.forEach(a -> labels.add(a));
        data.setLabels(aList);
       //****************************************
